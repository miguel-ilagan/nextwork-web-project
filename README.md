...
1. Clone the repository:
    ```bash
    git clone https://github.com/miguel-ilagan/nextwork-web-project.git
    ```
...
Miguel Ilagan – [miguelilagan@hotmail.com](mailto:miguelilagan@hotmail.com)
- [LinkedIn](https://www.linkedin.com/in/miguelilagan/)
